...
public class EditNoteActivity extends AppCompatActivity {
    ...
    public static String Save_url = "http://192.168.43.4:80/app/editNoteApp.php";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //noinspection SimplifiableIfStatement
        if (id == R.id.delete){
            MyDialogs dialogss = new MyDialogs(EditNoteActivity.this,MyDialogs.TAG_DELETE_NOTE_EDIT,ID);
